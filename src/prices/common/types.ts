...
export class OracleContract {
  ...
  constructor(contractAddress: string = constants.NULL.TYPE_STRING, startBlock: i32 = -1) {
...
export class CustomPriceType {
  ...
  static initialize(_usdPrice: BigDecimal, _decimals: i32 = 0, _oracleType: string = ''): CustomPriceType {
